...
var _homeAnatolyWorkSemanticReactNode_modulesReactTransformHmrLibIndexJs2 = (0, _index6.default)({
    filename: 'src/components/elements/input/input.jsx',
...
var Input = _wrapComponent('Input')((_temp = _class = function (_React$Component) {
    ...
    _createClass(Input, [{
        ...
        value: function renderText() {
            ...
            return _react3.default.createElement(this.props.component, other, this.prepareInput());
        }
        ...
        value: function prepareInput() {
            ...
            var inputHTML = _react3.default.createElement('input', {
                key: 'input',
    ...
    state: _react3.default.PropTypes.oneOf(['disabled', 'error']),
