...
var _homeAnatolyWorkSemanticReactNode_modulesReactTransformHmrLibIndexJs2 = (0, _index6.default)({
    filename: 'src/components/modules/checkbox/checkboxfields.jsx',
...
var CheckboxFields = _wrapComponent('CheckboxFields')((_temp = _class = function (_Component) {
    ...
    _createClass(CheckboxFields, [{
        ...
        value: function renderChildren() {
            ...
            if (_react3.default.Children.count(this.props.children) === 1) {
                return this.cloneChild(index, _react3.default.Children.only(this.props.children));
            } else {
                return _react3.default.Children.map(this.props.children, function (child) {
                    if (child.type == _modules.Checkbox) {
                        ...
                        element = _react3.default.DOM.div({
                            key: index,
                            className: 'field'
                        }, element);
        ...
        value: function cloneChild(index, child) {
            ...
            return _react3.default.cloneElement(child, _extends({
                key: index,
        ...
        value: function getClasses() {
            var classes = {
                ...
                // variations
                fields: _react3.default.Children.count(this.props.children) > 1
            };
    ...
    children: _react3.default.PropTypes.oneOfType([_react3.default.PropTypes.array, _react3.default.PropTypes.node]),
    ...
    type: _react3.default.PropTypes.oneOf(['grouped', 'inline']).isRequired
}, _class.defaultProps = {
    component: 'div',
    defaultClasses: true
}, _temp));
